...
{
        /// <summary>
        /// 模块编号:jb_szjy_logic_apps_MD5Encrypt
        /// 模块作用:传入明文字符串通过Md5加密算法加密成密文
        /// </summary>
        public class MD5Encrypt
        {
            ...
            /// <summary>
            /// 用户调用的方法， sMessage是输入的字串，stype密文的长度

            /// </summary>
            /// <param name="sMessage"></param>
            /// <param name="stype"></param>
            /// <returns></returns>
            public string MD5_Encrypt(string sMessage, int stype)
            {
                string md5 = Encrypt(sMessage, stype);
                return md5;
